...
enum SdfDelayType { DELAY_ABSOLUTE, DELAY_INCREMENT };

struct SdfPortSpec {
    enum     EdgeType { EDGE_NA, EDGE_01, EDGE_10, EDGE_0Z, EDGE_Z1, EDGE_1Z,
                        EDGE_Z0 };
...
struct SdfDelayDef {
    enum              Type { IO_DELAY, IO_RETAIN, PORT_DELAY, INTER_DELAY,
                             DEVICE_DELAY };
    Type              type;
    SdfPortSpec       pspec;
    char              *p1;
